(function ($) {
    ...
    $(document).ready(function () {
        ...
        var $addLink = $('<link>', {
            rel: 'stylesheet',
            href: 'public/assets/admin/css/dark.css',
            id: 'dark'
        });
        ...
        $(".cr-mode.dark").on("click", function () {
            ...
            $("link[href='public/assets/admin/css/style.css']").after($addLink);
    ...
    $(document).ready(function () {
        ...
        $('.update-status').click(function () {
            ...
            Swal.fire({
                ...
                html: `Bạn có chắc chắn muốn chuyển trạng thái đơn hàng sang <b style="color: red">${status}</b> không ?`,
                icon: 'info',
                showCancelButton: true,
