...
!function (e, t) {
    ...
    const je = e => {
            ...
            if (e.target === t || A().contains(e.target)) {
                Pe = !0;
                const n = De(e);
                Te = n.clientX, Se = n.clientY, Oe = parseInt(t.style.insetInlineStart) || 0, Me = parseInt(t.style.insetBlockStart) || 0
            }
        }, He = e => {
            const t = C();
            if (Pe) {
            ...
            if (n && o) {
                ...
                Y(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), Z($()), Ve(o, t), t.draggable && !t.toast ? (e => {
    ...
    const dn = e => {
        ...
        t.container.onclick = o => {
            un ? un = !1 : o.target === t.container && h(e.allowOutsideClick) && n(Ue.backdrop)
        }
    ...
    var wn = Object.freeze({
        ...
        argsToParams: e => {
            const t = {};
            return "object" != typeof e[0] || hn(e[0]) ? ["title", "html", "icon"].forEach(((n, o) => {
                const i = e[o];
                "string" == typeof i || hn(i) ? t[n] = i : void 0 !== i && d(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`)
    ...
    const Rn = (e, t, n) => new Promise(((i, s) => {
            ...
            if (!t.toast) return h(t.allowEnterKey) ? void (Yn(e) || Xn(e, t) || We(-1, 1)) : (m("allowEnterKey"), void Zn())
        }, Yn = e => {
    ...
    })), Fn.DismissReason = Ue, Fn.version = "11.15.0";
    const Jn = Fn;
