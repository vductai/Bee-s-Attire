...
!function (t) {
    ...
    !function () {
        ...
        t.fn.mixItUp = function () {
            var t = arguments[0], n = arguments[1], a = Array.prototype.slice.call(arguments, 1), i = [], o = [];
        ...
        constructor: e.Mixer, attach: function (a, i, o, r) {
            ...
            } else for (a = o.querySelectorAll(n.selector), c = 0; i = a[c]; c++) s = t.getControl(i, n.type, ""), s && t.controls.push(s);
            ...
            var a = this, i = null, o = a.dom.parent.getBoundingClientRect(), r = null, s = -1;
            ...
            for (a.callActions("beforeDiffDatasets", arguments), d = 0; r = t.newDataset[d]; d++) {
                if ("undefined" == typeof (h = r[a.config.data.uidKey]) || h.toString().length < 1) throw new TypeError(e.messages.errorDatasetInvalidUidKey({uidKey: a.config.data.uidKey}));
                if (f[h]) throw new Error(e.messages.errorDatasetDuplicateUid({uid: h}));
            ...
            var n = this, a = null, i = null, o = document.createElement("div"), r = "";
            ...
            var t = this, n = t.parseDatasetArgs(arguments), a = t.getDataOperation(n.command.dataset), i = null,
                o = !1;
