          ...
          <div class="banner-slider">
            <div class="slider slider-for">
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                    src="{{ asset('assets/img/product/9.jpg') }}"
                    alt="product-tab-1"
                    class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                    src="{{ asset('assets/img/product/12.jpg') }}"
                    alt="product-tab-1"
                    class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                    src="{{ asset('assets/img/product/13.jpg') }}"
                    alt="product-tab-2"
                    class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                    src="{{ asset('assets/img/product/14.jpg') }}"
                    alt="product-tab-3"
                    class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                    src="{{ asset('assets/img/product/15.jpg') }}"
                    alt="product-tab-1"
                    class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                    src="{{ asset('assets/img/product/16.jpg') }}"
                    alt="product-tab-2"
                    class="product-image"
                  />
                </div>
            ...
            <div class="slider slider-nav thumb-image">
              <div class="thumbnail-image">
                <div class="thumbImg">
                  <img src="{{ asset('assets/img/product/9.jpg') }}" alt="product-tab-1" />
                </div>
              </div>
              <div class="thumbnail-image">
                <div class="thumbImg">
