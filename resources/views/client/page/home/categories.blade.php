            ...
            <div class="row mb-minus-24">
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/3.jpg') }}"
                    alt="categories-3"
                  />
                </div>
              </div>
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/4.jpg') }}"
                    alt="categories-4"
                  />
                </div>
              </div>
            ...
            <div class="row mb-minus-24">
              <div class="col-6 cr-categories-box">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/1.jpg') }}"
                    alt="categories-1"
                  />
                </div>
              </div>
              <div class="col-6 cr-categories-box">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/2.jpg') }}"
                    alt="categories-2"
                  />
                </div>
              </div>
            ...
            <div class="row mb-minus-24">
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/5.jpg') }}"
                    alt="categories-5"
                  />
                </div>
              </div>
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/6.jpg') }}"
                    alt="categories-6"
                  />
                </div>
              </div>
            ...
            <div class="row mb-minus-24">
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/7.jpg') }}"
                    alt="categories-7"
                  />
                </div>
              </div>
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/8.jpg') }}"
                    alt="categories-8"
                  />
                </div>
              </div>
            ...
            <div class="row mb-minus-24">
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/9.jpg') }}"
                    alt="categories-9"
                  />
                </div>
              </div>
              <div class="col-6 cr-categories-box mb-24">
                <div class="cr-side-categories">
                  ...
                  <img
                    src="{{ asset('assets/img/categories/10.jpg') }}"
                    alt="categories-10"
                  />
                </div>
              </div>
