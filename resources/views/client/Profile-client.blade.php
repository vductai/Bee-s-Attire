            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img src="{{ asset('upload/' . auth()->user()->avatar) }}" alt="Profile Picture"
                            style="width: 200px;height: 200px; object-fit: cover" class="rounded-circle img-fluid mb-3"
                            id="profilePicture">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-start">
                            <p class="me-3">Ngày tham
                                gia:
                                {{ auth()->user()->birthday ? \Carbon\Carbon::parse(auth()->user()->birthday)->format('d-m-Y') : 'Trống' }}
                            </p>
                        ...
                        <div class="tab-content mt-3" id="myTabContent">
                                            ...
                                            @foreach ($vouchers as $item)
                                                <div class="col">
                                                    <div class="voucher-card">
                                                        ...
                                                        <div class="voucher-discount">{{ $item->voucher_price }}% OFF
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                                ...
                                <form id="changePasswordForm">
                                    ...
                                    <button type="submit" class="cr-button btn-primary">Đổi mật khẩu</button>
                                </form>
                                <br>
                                <p id="response-message" class="text-danger"></p>
                            </div>
                    ...
                    <form id="editProfileForm" action="{{ route('update-profile') }}" enctype="multipart/form-data"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="phone" id="editEmail"
                                value="{{ auth()->user()->phone ?? 'Trống' }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="address" id="editEmail"
                                value="{{ auth()->user()->address ?? 'Trống' }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="cr-button btn-primary" id="saveProfileChanges">Save
                                changes</button>
                        </div>
                    </form>
                </div>
          ...
          error: function(xhr) {
            if (xhr.status === 422) {
              ...
              if (errors.current_password) {
                ...
                $('#current_password').next('.invalid-feedback').text(errors.current_password);
              }
              if (errors.new_password) {
                $('#new_password').addClass('is-invalid');
                $('#new_password').next('.invalid-feedback').text(errors.new_password);
              }
              if (errors.confirm_password) {
                $('#confirm_password').addClass('is-invalid');
                $('#confirm_password').next('.invalid-feedback').text(errors.confirm_password);
              }
            } else {
              $('#message').html('<div class="alert alert-danger">Đã xảy ra lỗi. Vui lòng thử lại sau.</div>');
            }
          }
        });
      });
