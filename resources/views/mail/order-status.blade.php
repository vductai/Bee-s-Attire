    ...
    <div class="email-body">
        ...
        @if($order->status === 'Đã xác nhận')
            <p>Chúng tôi thông báo với bạn rằng đơn hàng có mã <strong>#{{$order->order_id}}</strong>
                của bạn đã được xác nhận và sẻ gửi cho quý khách sớm nhất.</p>
        @elseif($order->status === 'Đã giao hàng')
            <p>Chúng tôi thông báo với bạn rằng đơn hàng có mã <strong>#{{$order->order_id}}</strong>
                của bạn đã được giao đi thành công, vui lòng kiểm tra điện thoại để nhận thông tin từ shipper.</p>
        @endif
        <!-- Order Information -->
