                  ...
                  <div class="cr-blog-recent">
                      ...
                      <div class="cr-blog-recent-post">
                          <div class="cr-blog-recent-image">
                              <img src="{{ asset('client/img/blog/1.jpg') }}" alt="blog-1">
                          </div>
                  ...
                  <div class="cr-blog-gallery">
                      ...
                      <div class="cr-blog-instagram-image">
                          <div class="cr-blog-instagram-image-inner">
                              <a href="#">
                                  <img src="{{ asset('client/img/insta/1.jpg') }}" alt="1">
                              </a>
                              <a href="#">
                                  <img src="{{ asset('client/img/insta/2.jpg') }}" alt="2">
                              </a>
                              <a href="#">
                                  <img src="{{ asset('client/img/insta/3.jpg') }}" alt="3">
                              </a>
                              <a href="#">
                                  <img src="{{ asset('client/img/insta/4.jpg') }}" alt="4">
                              </a>
                              <a href="#">
                                  <img src="{{ asset('client/img/insta/5.jpg') }}" alt="5">
                              </a>
                              <a href="#">
                                  <img src="{{ asset('client/img/insta/6.jpg') }}" alt="6">
                              </a>
                          </div>
                      </div>
                  </div>
          ...
          <div class="col-lg-9 col-12 md-30">
              <div class="cr-blog-classic" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                  ...
                  <div class="cr-blog-image">
                      <img src="{{ asset('client/img/blog/blog-1') }}.jpg" alt="blog-1">
                  </div>
              </div>
              <div class="cr-blog-classic" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                  <div class="cr-blog-classic-content">
                  ...
                  <div class="cr-blog-image">
                      <img src="{{ asset('client/img/blog/blog-2') }}.jpg" alt="blog-2">
                  </div>
              </div>
              <div class="cr-blog-classic" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                  <div class="cr-blog-classic-content">
                  ...
                  <div class="cr-blog-image">
                      <img src="{{ asset('client/img/blog/blog-3') }}.jpg" alt="blog-3">
                  </div>
              </div>
