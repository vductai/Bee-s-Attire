                                        ...
                                        <div class="thumb-upload">
                                            <div class="thumb-edit">
                                                <input type='file' id="thumbUpload01" class="cr-image-upload"
                                                    name="product_images[]" accept=".png, .jpg, .jpeg">
                                                <label><i class="ri-pencil-line"></i></label>
                                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="product_name" class="form-control slug-title"
                                            value="{{ old('product_name') }}" id="inputEmail4">
                                        @error('product_name')
                                            <p class="text-danger">{{ $messages }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-12">
                                            <input name="slug" id="slug" class="form-control here set-slug"
                                                type="hidden">
                                            <input id="slugs" class="form-control here set-slug" type="text"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
