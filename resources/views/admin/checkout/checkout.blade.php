                                    ...
                                    <div class="cr-product-inner">
                                        <div class="cr-pro-image-outer">
                                            <div class="cr-pro-image">
                                                <a href="#" class="image">
                                                    <img class="main-image" src="{{asset('img/product/10.jpg')}}"
                                                         alt="Product">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="cr-pro-content cr-product-details">
                                            <h5 class="cr-pro-title"><a href="#">Dates Value
                                                    Pack Pouch</a></h5>
                                ...
                                <div class="col-sm-12 mb-0">
                                    <div class="cr-product-inner">
                                        <div class="cr-pro-image-outer">
                                            <div class="cr-pro-image">
                                                <a href="#" class="image">
                                                    <img class="main-image" src="{{asset('img/product/12.jpg')}}"
                                                         alt="Product">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="cr-pro-content cr-product-details">
                                            <h5 class="cr-pro-title"><a href="#">Smoked
                    ...
                    <div class="cr-checkout-inner">
                        <div class="cr-checkout-wrap mb-30">
                            <div class="cr-checkout-block cr-check-login">
                                <h3 class="cr-checkout-title">Recipient address</h3>
                                    ...
                                    <div class="cr-check-bill-form mb-minus-24">
                                        <form action="#" method="post">
                                            ...
                                            <span class="cr-bill-wrap">
                                                    <label>Address</label>
                                                    <input type="text" name="address" placeholder="Address New">
                                                </span>
                                            <span class="cr-bill-wrap cr-bill-half">
                                                    <label>City *</label>
