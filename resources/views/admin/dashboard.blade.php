                        ...
                        <div class="cr-card-content label-card">
                            <div class="title">
                                ...
                                <div class="growth-numbers">
                                    <h4>TotalUsers</h4>
                                    <h5>{{ $totalUsers }}</h5> <!-- Hiển thị tổng số đơn hàng -->
                                </div>
                            </div>
                        ...
                        <div class="cr-card-content label-card">
                            <div class="title">
                                ...
                                <div class="growth-numbers">
                                    ...
                                    <h5>{{ $totalProducts }}</h5> <!-- Hiển thị số lượng sản phẩm bán chạy -->
                                </div>
                            </div>
                    ...
                    <div class="cr-card">
                        <div class="cr-card-content label-card">
                            <div class="title">
                                ...
                                <div class="growth-numbers">
                                    <h4>TotalViews</h4>
                                    <h5>{{ $totalViews }}</h5> <!-- Hiển thị số lượng sản phẩm được xem nhiều nhất -->
                                </div>
                            </div>
                            <p class="card-groth down">
                                <i class="ri-arrow-down-line"></i>
                        ...
                        <div class="cr-card-content label-card">
                            <div class="title">
                                ...
                                <div class="growth-numbers">
                                    ...
                                    {{-- <h5>${{ number_format($totalRevenue, 2) }}</h5> <!-- Hiển thị doanh thu --> --
            ...
            <div class="cr-card revenue-overview">
                <div class="cr-card-header header-575">
                    ...
                    <div class="header-tools">
                        <a href="javascript:void(0)" class="m-r-10 cr-full-card" title="Full Screen"><i class="ri-fullscreen-line"></i></a>
                ...
                <div class="cr-card-content">
                    <div class="cr-chart-header">
                        ...
                        <div class="block">
                            <h6>Revenue</h6>
                            <h5>${{ number_format($totalRevenue, 2) }}
                                <span class="up"><i class="ri-arrow-up-line"></i>%</span>
                            </h5>
                        </div>
                        <div class="block">
                            <h6>Expenses</h6>
                            <h5>${{ number_format($totalExpenses, 2) }}
                                <span class="down"><i class="ri-arrow-down-line"></i>%</span>
                            </h5>
                        </div>
                        <div class="block">
                            <h6>Profit</h6>
                            <h5>${{ number_format($totalProfit, 2) }}
                                <span class="up"><i class="ri-arrow-up-line"></i>%</span>
                            </h5>
                        </div>
                    </div>
...
<script>
    ...
    var topSellingProduct = @json($topSellingProduct);
            ...
            <div class="cr-card revenue-overview">
                ...
                <div class="cr-card-content">
                    <div class="cr-chart-header">
                        ...
                        <div class="block">
                            <h6>Revenue</h6>
                            <h5>{{ number_format($totalRevenue, 0, ',', '.') }} VNĐ
                                <span class="up"><i class="ri-arrow-up-line"></i></span>
                            </h5>
                        </div>
                        <div class="block">
                            <h6>topSellingProducts</h6>
                            <h5>{{ $topSellingProduct }}
                                <span class="down"><i class="ri-arrow-down-line"></i></span>
                            </h5>
                        </div>
                        <div class="block">
