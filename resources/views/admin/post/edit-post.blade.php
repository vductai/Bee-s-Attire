...
@section('content_admin')
    ...
    <div class="row">
        <form class="col-md-12" id="formPostUpdate">
                                ...
                                <form class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="titlePost"
                                               value="{{$post->title}}"
                                               class="form-control title slug-title" name="title">
                                        <p class="text-danger errpost" id="title-error"></p>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Slug</label>
                                        <div class="col-12">
                                            <input id="slugPost" name="slug"
                                                   value="{{$post->slug}}"
                                                   class="form-control here slg set-slug" type="text">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="desc"
                                               value="{{$post->desc}}"
                                               class="form-control slug-title" name="desc">
                                        <p class="text-danger errpost" id="desc-error"></p>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Nội dung bài viết</label>
                                        <textarea name="content"
                                                  id="editor1" cols="80" rows="70">{!! $post->content !!}</textarea>
                                        <p class="text-danger errpost" id="content-error"></p>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <button type="submit" class="btn cr-btn-primary">Sửa bài viết</button>
                                    </div>
                                </form>
                            </div>
                        </div>
