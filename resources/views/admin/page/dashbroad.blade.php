                        ...
                        <div class="best-seller-table">
                            <div class="table-responsive">
                                <table id="best_seller_data_table" class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/clients/1.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/clients/2.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/clients/3.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/clients/4.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/clients/5.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/clients/6.jpg')}}"
                        ...
                        <div class="top-product-table">
                            <div class="table-responsive">
                                <table id="top_product_data_table" class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/product/1.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/product/2.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/product/3.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/product/4.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/product/5.jpg')}}"
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="{{asset('img/product/6.jpg')}}"
                            ...
                            <div class="table-responsive">
                                <table id="recent_order_data_table" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="cat-thumb" src="{{asset('img/product/7.jpg')}}"
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="cat-thumb" src="{{asset('img/product/8.jpg')}}"
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="cat-thumb" src="{{asset('img/product/9.jpg')}}"
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="cat-thumb" src="{{asset('img/product/10.jp')}}g"
                                                 alt="clients Image"><span class="name">Camera Dron</span>
                                        </td>
                                        <td>Anne Ortha</td>
                                        <td>$854</td>
